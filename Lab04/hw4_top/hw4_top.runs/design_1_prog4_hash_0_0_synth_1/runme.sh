...
HD_PWD='D:/Vivado/project/hw4_top/hw4_top.runs/design_1_prog4_hash_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_prog4_hash_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_prog4_hash_0_0.tcl
