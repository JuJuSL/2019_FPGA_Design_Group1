...
-- Date        : Sat Nov  9 16:06:48 2019
-- Host        : DESKTOP-1OT66UM running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/Vivado/project/hw4_top/hw4_top.srcs/sources_1/bd/design_1/ip/design_1_PWM_0_0/design_1_PWM_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_PWM_0_0_PWM is
  ...
  signal \counter_256_reg__0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of R_out_i_1 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \counter_976562[10]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \counter_976562[19]_i_6\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter_976562[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_976562[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_976562[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter_976562[5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_976562[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_976562[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_976562[8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_976562[9]_i_1\ : label is "soft_lutpair6";
...
B_out0_carry_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => \counter_256_reg__0\(7),
      I1 => B_out0_carry_0(7),
      I2 => B_out0_carry_0(6),
      I3 => \counter_256_reg__0\(6),
...
B_out0_carry_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => \counter_256_reg__0\(5),
      I1 => B_out0_carry_0(5),
      I2 => B_out0_carry_0(4),
      I3 => \counter_256_reg__0\(4),
...
B_out0_carry_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => \counter_256_reg__0\(3),
      I1 => B_out0_carry_0(3),
      I2 => B_out0_carry_0(2),
      I3 => \counter_256_reg__0\(2),
...
B_out0_carry_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => \counter_256_reg__0\(1),
      I1 => B_out0_carry_0(1),
      I2 => B_out0_carry_0(0),
      I3 => \counter_256_reg__0\(0),
...
\counter_256[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
        ...
        port map (
      I0 => \counter_256_reg__0\(2),
      I1 => \counter_256_reg__0\(0),
      I2 => \counter_256_reg__0\(1),
      O => \p_0_in__0\(2)
    );
...
\counter_256[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
        ...
        port map (
      I0 => \counter_256_reg__0\(4),
      I1 => \counter_256_reg__0\(2),
      I2 => \counter_256_reg__0\(3),
      I3 => \counter_256_reg__0\(1),
      I4 => \counter_256_reg__0\(0),
      O => \p_0_in__0\(4)
    );
\counter_256[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \counter_256_reg__0\(0),
      I2 => \counter_256_reg__0\(1),
      I3 => \counter_256_reg__0\(3),
      I4 => \counter_256_reg__0\(2),
      I5 => \counter_256_reg__0\(4),
      O => \p_0_in__0\(5)
    );
\counter_256[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
        ...
        port map (
      I0 => \counter_256_reg__0\(6),
      I1 => \counter_256_reg__0\(4),
      I2 => \counter_976562[19]_i_3_n_0\,
      I3 => \counter_256_reg__0\(5),
      O => \p_0_in__0\(6)
    );
...
\counter_976562[19]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
        ...
        port map (
      I0 => counter_976562(12),
      I1 => counter_976562(4),
      I2 => counter_976562(13),
      I3 => counter_976562(15),
...
PWM: entity work.design_1_PWM_0_0_PWM
     port map (
