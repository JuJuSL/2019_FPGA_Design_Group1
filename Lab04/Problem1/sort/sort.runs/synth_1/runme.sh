...
HD_PWD='C:/Users/JUJUSL/projects/sort/sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_wrapper.tcl
