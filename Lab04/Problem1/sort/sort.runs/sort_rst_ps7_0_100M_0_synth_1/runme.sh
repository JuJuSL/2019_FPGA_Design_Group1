...
HD_PWD='C:/Users/JUJUSL/projects/sort/sort.runs/sort_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_rst_ps7_0_100M_0.tcl
