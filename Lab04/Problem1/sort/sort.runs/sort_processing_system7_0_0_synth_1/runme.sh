...
HD_PWD='C:/Users/JUJUSL/projects/sort/sort.runs/sort_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_processing_system7_0_0.tcl
