...
HD_PWD='C:/Users/JUJUSL/projects/sort/sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sort_wrapper.tcl -notrace
