...
HD_PWD='C:/Users/JUJUSL/projects/sort/sort.runs/sort_sort_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_sort_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_sort_0_0.tcl
