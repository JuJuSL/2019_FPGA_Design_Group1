...
HD_PWD='C:/Users/JUJUSL/projects/PWM/PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_wrapper.tcl -notrace
