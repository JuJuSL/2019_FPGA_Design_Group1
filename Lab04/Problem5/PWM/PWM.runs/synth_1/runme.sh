...
HD_PWD='C:/Users/JUJUSL/projects/PWM/PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_wrapper.tcl
