...
HD_PWD='C:/Users/JUJUSL/projects/PWM/PWM.runs/PWM_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_processing_system7_0_0.tcl
