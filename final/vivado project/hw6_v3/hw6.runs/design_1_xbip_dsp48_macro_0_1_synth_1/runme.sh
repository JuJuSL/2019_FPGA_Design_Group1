...
HD_PWD='D:/Vivado/project/hw6/hw6.runs/design_1_xbip_dsp48_macro_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xbip_dsp48_macro_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xbip_dsp48_macro_0_1.tcl
