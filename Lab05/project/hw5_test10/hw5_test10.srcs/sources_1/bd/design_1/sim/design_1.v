...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=3,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  output led4_b;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.LED5_G RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.LED5_G, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) output led5_g;
  ...
  wire [31:0]bram_interface_0_addr;
  wire [31:0]bram_interface_0_b_wdata;
  wire bram_interface_0_en;
  wire bram_interface_0_rstout;
  wire [3:0]bram_interface_0_we;
  ...
  assign led4_b = bram_interface_0_rstout;
  assign led5_g = axi_bram_ctrl_0_bram_rst_a;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(bram_interface_0_addr),
        .clka(axi_bram_ctrl_0_bram_clk_a),
        .clkb(axi_bram_ctrl_0_bram_clk_a),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(bram_interface_0_b_wdata),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(bram_interface_0_en),
        .rsta(axi_bram_ctrl_0_bram_rst_a),
        .rstb(bram_interface_0_rstout),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(bram_interface_0_we));
  design_1_bram_interface_0_0 bram_interface_0
       (.addr(bram_interface_0_addr),
        .b_rdata(blk_mem_gen_0_doutb),
        .b_wdata(bram_interface_0_b_wdata),
        .clk(processing_system7_0_FCLK_CLK0),
        .en(bram_interface_0_en),
        .rst(rst_ps7_0_100M_peripheral_aresetn),
        .rstout(bram_interface_0_rstout),
        .we(bram_interface_0_we));
