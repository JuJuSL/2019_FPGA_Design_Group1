...
proc create_root_design { parentCell } {
  ...
  set led5_g [ create_bd_port -dir O -type rst led5_g ]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_ports led5_g] [get_bd_pins axi_bram_ctrl_0/bram_rst_a] [get_bd_pins blk_mem_gen_0/rsta]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins bram_interface_0/b_rdata]
  connect_bd_net -net bram_interface_0_addr [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins bram_interface_0/addr]
  connect_bd_net -net bram_interface_0_b_wdata [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins bram_interface_0/b_wdata]
  connect_bd_net -net bram_interface_0_en [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins bram_interface_0/en]
  connect_bd_net -net bram_interface_0_rstout [get_bd_ports led4_b] [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins bram_interface_0/rstout]
  connect_bd_net -net bram_interface_0_we [get_bd_pins blk_mem_gen_0/web] [get_bd_pins bram_interface_0/we]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins bram_interface_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bram_interface_0/rst] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
