...
HD_PWD='D:/Vivado/project/hw5_test10/hw5_test10.runs/design_1_bram_interface_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_interface_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_interface_0_0.tcl
